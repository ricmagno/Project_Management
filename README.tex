...
User story &  & x &  & x &  & x &  & \\
\end{tabular}
\end{center}\footnotetext[1]{\label{orgacff86c}Team}\footnotetext[2]{\label{org47dc37b}Stakeholders}\footnotetext[3]{\label{org89dd3e5}Dev Approach and Life Cycle}\footnotetext[4]{\label{org09826ad}Planning}\footnotetext[5]{\label{orga4ad6ed}Project Work}\footnotetext[6]{\label{org0223c7f}Delivery}\footnotetext[7]{\label{orgedd0af3}Measurement}\footnotetext[8]{\label{org5f7b869}Uncertainty}
